...
class VehicleListViewTest(TestCase):
    ...
    @patch("vin_charts.views.ListView.get_context_data", return_value={})
    def test_get_context_data(self, get_context_data):
        # setup
        view = VehicleList()
        view.kwargs = {"model_year": "2018"}
        context = view.get_context_data()

        # asserts
        self.assertEqual(context, {"year": "2018"})
